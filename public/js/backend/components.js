...
var BulkEditRow = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            "tr",
            { "data-row-id": this.props.idx, className: row_class },
                ...
                return React.createElement(
                    ...
                    function () {
                        if (field_content.type == 'image') return React.createElement(
                            ...
                            React.createElement("img", { src: field_content.value, width: "96", height: "96" })
                        );else if (field_content.type == 'literal') return React.createElement(
                            "span",
                            null,
                            field_content.value
                        );else if (field_content.type == 'href') return React.createElement(
                            "a",
                            { target: "_blank", href: field_content.href },
                            field_content.value
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        "button",
                                        { "data-method": "change", onClick: this.saveCategoriesDialog, className: "btn btn-success dialog-add-categories-save" },
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        "button",
                                        { "data-method": "add", onClick: this.saveCategoriesDialog, className: "btn btn-success dialog-add-categories-save" },
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    rows_data.map(function (row_data, idx) {
                        return React.createElement(BulkEditRow, { category: element.state.category, idx: idx, data: row_data });
                    }),
                    function () {
